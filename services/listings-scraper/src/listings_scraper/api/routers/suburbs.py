...
from listings_scraper.services.suburb_summary import SuburbSummary, SuburbSummaryService
from listings_scraper.suburb_autocomplete import autocomplete as _autocomplete
