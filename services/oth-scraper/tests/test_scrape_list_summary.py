...
from oth_scraper.services.scrape_list_summary import ScrapeListSummaryService
...
async def test_summary_raises_for_missing_list(session_factory) -> None:
    async with session_factory() as session:
        ...
        from oth_scraper.services.scrape_list import ScrapeListNotFoundError
